...
export default function WorkshopInvitation() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24 animate-in fade-in slide-in-from-bottom-10 duration-1000">
      <Card className="p-8 py-16 md:p-20 border-none bg-white finance-3d-shadow rounded-[3rem] md:rounded-[4rem] relative overflow-hidden">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
          <div className="relative z-10 space-y-8 md:space-y-10 text-center lg:text-left">
            ...
            <h2 className="text-3xl md:text-6xl lg:text-7xl font-headline font-bold text-primary tracking-tight leading-[1.1]">
            ...
            <div className="pt-4 flex justify-center lg:justify-start">
              <Button 
                ...
                className="h-16 md:h-24 px-10 md:px-20 rounded-3xl md:rounded-[2rem] bg-primary text-white font-bold text-lg md:text-3xl finance-3d-shadow hover:scale-110 active:scale-95 transition-all flex items-center gap-4 md:gap-6 group relative overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                <GraduationCap className="w-6 h-6 md:w-10 md:h-10 group-hover:rotate-12 transition-transform" /> 
                Invite Us Now 
          ...
          <div className="relative hidden lg:flex items-center justify-center">
            <div className="grid grid-cols-2 gap-8 w-full max-w-lg">
              <Card className="p-10 border-none finance-3d-shadow bg-slate-50 rounded-[3rem] flex flex-col items-center text-center gap-6 hover:scale-110 hover:-rotate-3 transition-all duration-500 group">
              ...
              <Card className="p-10 border-none finance-3d-shadow bg-slate-50 rounded-[3rem] flex flex-col items-center text-center gap-6 translate-y-12 hover:scale-110 hover:rotate-3 transition-all duration-500 group">
