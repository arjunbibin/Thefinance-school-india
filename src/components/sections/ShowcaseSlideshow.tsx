  ...
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-24">
      <div className="mb-10 text-center px-4">
        ...
        <h2 className="text-2xl md:text-5xl font-headline font-bold text-primary">Experience <span className="text-accent">The School</span></h2>
        <p className="text-muted-foreground mt-3 max-w-2xl mx-auto text-xs md:text-base opacity-80">Take a glimpse into our interactive workshops and collaborative learning environment.</p>
      </div>
