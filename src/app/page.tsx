            ...
            <Card className="p-10 border-none bg-primary text-white rounded-[3rem] finance-3d-shadow relative overflow-hidden">
               <div className="relative z-10 space-y-8">
                  ...
                  <div className="pt-8 border-t border-white/10 mt-8">
                    <Link href="/dashboard" className="inline-flex items-center gap-3 px-6 py-2 rounded-xl bg-white/10 hover:bg-white/20 transition-all text-sm font-bold uppercase tracking-widest">
